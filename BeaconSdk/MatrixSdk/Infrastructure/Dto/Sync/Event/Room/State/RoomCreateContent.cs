namespace MatrixSdk.Infrastructure.Dto.Sync.Event.Room.State
{
    ...
    public record RoomCreateContent
    {
        ...
        /// </summary>
        [JsonProperty("creator")] public string RoomCreatorUserId { get; init; }

        /// <summary>
        ///     Whether users on other servers can join this room. Defaults to <b>true</b> if key does not exist.
        /// </summary>
        [JsonProperty("m.federate")] public bool Federate { get; init; }
    ...
    public record PreviousRoom
    {
        ...
        /// </summary>
        [JsonProperty("room_id")] public string OldRoomId { get; init; }

        /// <summary>
        ///     <b>Required.</b> The event ID of the last known event in the old room.
        /// </summary>
        [JsonProperty("event_id")] public string LastKnownEventId { get; init; }
    }
}