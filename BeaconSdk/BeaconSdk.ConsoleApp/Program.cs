namespace BeaconSdk.ConsoleApp
{
    ...
    internal class Program
    {
        ...
        // {
            ...
            //     null);
            //
            // var t = JsonConvert.SerializeObject(pairingResponse);
            // if (t == "null") t = " empty";
            // Console.WriteLine(t);
        ...
        private static async Task<(MatrixClient, TextMessageListener)> SetupClientWithTextListener(IServiceProvider serviceProvider)
        {
            ...
            var cryptoService = serviceProvider.GetRequiredService<SignatureCryptoService>();

            var seed = Guid.NewGuid().ToString();
            var keyPair = SignatureCryptoService.GenerateEd25519KeyPair(seed);
