namespace Matrix.Sdk
{
    ...
    public class MatrixClient
    {
        ...
        public async Task StartAsync(KeyPair keyPair)
        {
            ...
            LoginResponse response = await _networkService.LoginAsync(_cts.Token, keyPair);
        ...
        private async Task PollAsync(CancellationToken cancellationToken)
        {
            ...
            SyncResponse response = await _networkService.SyncAsync(_stateManager.AccessToken,
