namespace Matrix.Sdk.Core.Application.Network
{
    ...
    public interface INetworkService
    {
        ...
        Task<MatrixRoom> CreateTrustedPrivateRoomAsync(ClientStateManager stateManager,
            CancellationToken cancellationToken,
            string[]? invitedUserIds = null);

        Task<MatrixRoom> JoinTrustedPrivateRoomAsync(ClientStateManager stateManager,
            CancellationToken cancellationToken, string roomId);

        Task<string?> SendMessageAsync(ClientStateManager stateManager, CancellationToken cancellationToken,
